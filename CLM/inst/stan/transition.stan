data{
  ...
  int<lower=1> n_inc[J,T-1];  // number of individuals with incomplete observations
  int<lower=1> n_star[J,T-1]; // number of completed individuals that had not observed the endpoint at time tau     
